...
public class NetworkControllerImpl extends BroadcastReceiver
    ...
    private int getVolteResId(boolean volte1, boolean volte2) {
        if (volte1 && volte2) {
            ...
            return R.drawable.stat_sys_volte_slot2; //hack
        } else if (volte2) {
            return R.drawable.stat_sys_volte_slot1; //hack
        }
        return 0;
    }
    ...
    private int getVowifiResId(boolean vowifi1, boolean vowifi2) {
        if (vowifi1 && vowifi2) {
            ...
            return R.drawable.stat_sys_vowifi_slot2; //hack
        } else if (vowifi2) {
            return R.drawable.stat_sys_vowifi_slot1; //hack
        }
        return 0;
    }
